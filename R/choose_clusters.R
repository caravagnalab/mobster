                           ...
                           verbose = FALSE)
{
  ...
  if(verbose)
  {
    ...
    cli::cli_text(mobster:::m_inf(paste0(" v > {.field {", Beta_variance_cutoff, '}} (minimum Beta variance)')))
  }
  ...
  # Report easy cases
  if(sum(!tab_clusters$retain) == nrow(tab_clusters)) stop("All clusters filtered out, will stop this computation.")
