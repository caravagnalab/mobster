...
The package integrates evolutionary theory and Machine-Learning to analyze (e.g., whole-genome) bulk cancer sequencing data. This analysis problem relates to clustering; we approach it via a maximum-likelihood formulation (mixture models), and use bootstrap routines to assess confidence of the parameters. The package implements S3 objects to visualize the data and the fits
