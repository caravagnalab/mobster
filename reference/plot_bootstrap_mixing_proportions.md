...
call to `bootstrapped_statistics`, a boxplot with the mixing proportions
is produced.
...
#> 
#> [easypar] 2025-11-21 08:52:34.050708 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> [easypar] 2025-11-21 08:52:37.611236 - Overriding parallel execution setup [TRUE] with global option : FALSE
#>  [ MOBSTER fit ] 
#> 
#> ✔ Loaded input data, n = 200.
#> ❯ n = 200. Mixture with k = 1,2 Beta(s). Pareto tail: TRUE and FALSE. Output
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:52:37.656056 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:52:41.586585 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:52:44.933357 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
#> ℹ MOBSTER fits completed in 3.4s.
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:52:48.383383 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:52:52.106871 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
