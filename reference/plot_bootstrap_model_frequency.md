...
call to `bootstrapped_statistics`, a barplot with the model frequency is
produced
...
#> 
#> [easypar] 2025-11-21 08:52:56.659901 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> [easypar] 2025-11-21 08:53:00.198694 - Overriding parallel execution setup [TRUE] with global option : FALSE
#>  [ MOBSTER fit ] 
#> 
#> ✔ Loaded input data, n = 200.
#> ❯ n = 200. Mixture with k = 1,2 Beta(s). Pareto tail: TRUE and FALSE. Output
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:53:00.244352 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:53:04.192489 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:53:07.544455 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
#> ℹ MOBSTER fits completed in 4.2s.
#> 
#> ── [ MOBSTER ] My MOBSTER model n = 200 with k = 2 Beta(s) without tail ────────
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:53:11.835737 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:53:15.489311 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
#> ℹ MOBSTER fits completed in 3.6s.
#> 
