...
#> 
#> [easypar] 2025-11-21 08:53:19.790844 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> [easypar] 2025-11-21 08:53:23.278012 - Overriding parallel execution setup [TRUE] with global option : FALSE
#>  [ MOBSTER fit ] 
#> 
#> ✔ Loaded input data, n = 200.
#> ❯ n = 200. Mixture with k = 1,2 Beta(s). Pareto tail: TRUE and FALSE. Output
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:53:23.322618 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:53:27.205124 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:53:30.503481 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:53:33.925737 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ❯ Scoring (without parallel) 2 x 2 x 2 = 8 models by reICL.
#> 
#> [easypar] 2025-11-21 08:53:37.596265 - Overriding parallel execution setup [FALSE] with global option : FALSE
#> 
#> 
...
#> ! No tail have been fit in these bootstraps, returning an empty plot
