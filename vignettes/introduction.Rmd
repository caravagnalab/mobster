...
# Run 15 nonparametric bootstraps, and compute the bootstrapped statistics. 
...
plot_bootstrap_model_frequency(fit)
```
...
mplot = plot_bootstrap_mixing_proportions(fit$best, bootstrap_results = bootstrap_results, bootstrap_statistics = bootstrap_statistics)  
