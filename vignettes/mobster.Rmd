...
cowplot::plot_grid(
  ggmuller::Muller_pop_plot(Muller_df) + 
    ...
    geom_vline(xintercept = 16, linetype = 'dashed', size = .3),
...
If you are confident about your clusters, you can [compute the clone trees](https://caravagn.github.io/mobster/articles/CloneTrees.html) that fit your MOBSTER analysis.

For a real case study with `mobster`, check the [Supplementary Data ](https://caravagn.github.io/) released with our paper. 

Check out also the [`evoverse` pipelines](https://caravagn.github.io/evoverse) that use `mobster`.
...
<a href="https://caravagn.github.io/evoverse"><img src="https://caravagn.github.io/evoverse/reference/figures/logo.png" width=77px height=91px></img></a>
</center>
<br>