...
You can plot the latent variables, which are used to determine *hard clustering* assignments of the input mutations. A `cutoff_assignment` determines a cut to prioritize assignments above the hard clustering assignments probability.

```{r, fig.width=5, fig.height=5}
ggpubr::ggarrange(
  mobster::plot_latent_variables(best_fit, cutoff_assignment = 0),
  mobster::plot_latent_variables(best_fit, cutoff_assignment = .8),
  ncol = 2,
  nrow = 1
)
```
