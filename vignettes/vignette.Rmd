...
- Beta distributions have unknown closed form for their MLE estimator, which we have to approximate numerically, slowing down the fit. However, their Moment-Matching (MM) estimator is known, and is analytical. For mixtures of Beta distributions, this has been first derived in [Schröder and Rahmann Algorithms Mol Biol (2017) 12:21]. If we consider the mean $\mu_k$ and the variance $\sigma_k$ of a Beta distribution, and we include latent variables 
\[
...
We fit the model, as before but with larger $K$. We reduce the number of trials and epsilon to speed up things.
